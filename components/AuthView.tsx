...
const AuthView: React.FC<AuthViewProps> = ({ onGuestLogin }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-4 text-center w-full">
        <h1 className="text-4xl md:text-5xl font-extrabold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-indigo-500">
            Flashcards IA
        </h1>
        ...
        <div className="w-full max-w-sm bg-slate-800 p-8 rounded-xl shadow-2xl border border-slate-700">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full py-3 px-4 bg-cyan-600 hover:bg-cyan-700 disabled:bg-slate-600 text-white font-bold rounded-md transition-colors shadow-lg"
                >
